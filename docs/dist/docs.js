...
if (form instanceof HTMLFormElement) {
  createFormValidator(form, createDefaultPreset());
	...
	events: [
		...
		{
			name: "a11y-form-validator:before-validate",
			description: "Full-form validation started.",
			detail: ["reason", "state"]
		},
		{
			name: "a11y-form-validator:field-pending",
			description: "A field entered validation.",
			detail: [
				"field",
				"fieldName",
				"element",
		...
		{
			name: "a11y-form-validator:field-valid",
			description: "A field validation succeeded.",
			detail: [
				"field",
				"fieldName",
				"valid",
		...
		{
			name: "a11y-form-validator:field-invalid",
			description: "A field validation failed.",
			detail: [
				"field",
				"fieldName",
				"valid",
		...
		{
			name: "a11y-form-validator:field-ignored",
			description: "A disabled, hidden, or selector-matched field was skipped.",
			detail: [
				"field",
				"fieldName",
				"ignoredReason",
		...
		{
			name: "a11y-form-validator:errors-changed",
			description: "The effective error snapshot changed.",
			detail: [
				"errors",
				"previousErrors",
				"source",
		...
		{
			name: "a11y-form-validator:after-validate",
			description: "A real full-form validation completed.",
			detail: [
				"valid",
				"reason",
				"errors",
		...
		{
			name: "a11y-form-validator:form-valid",
			description: "Full-form validation established a valid form.",
			detail: [
				"valid",
				"reason",
				"errors",
		...
		{
			name: "a11y-form-validator:form-invalid",
			description: "Validation or server errors established an invalid form.",
			detail: [
				"valid",
				"reason",
				"errors",
		...
		{
			name: "a11y-form-validator:submit-blocked",
			description: "An intercepted submission could not proceed.",
			detail: [
				"submitter",
				"cause",
				"error",
		...
		{
			name: "a11y-form-validator:submit-ready",
			description: "Submit validation succeeded before requestSubmit().",
			detail: [
				"submitter",
				"valid",
				"errors",
		...
		{
			name: "a11y-form-validator:refresh",
			description: "Dynamic field collection completed.",
			detail: ["reason", "state"]
		},
		{
			name: "a11y-form-validator:reset",
			description: "Validator reset completed.",
			detail: ["reason", "state"]
		},
		{
			name: "a11y-form-validator:destroy",
			description: "Validator cleanup completed.",
			detail: ["state"]
		}
	],
	accessibility: [
